...
# Fix failing tests (useful during refactoring)
test-fix:
	@echo "Running all tests and fixing failures..."
	go test ./internal/delivery/http/handler/...
	go test ./internal/delivery/http/middleware/...
	go test ./internal/repository/...
	go test ./internal/usecase/...
	@echo "Done running tests, fixing one by one."
